...
// Add Koumudi Patil to IIT Kanpur (Design/CogSci)
...
// Add DOIs to existing topPapers globally (a simple regex replacement to append a mock DOI if not present)
// The user noted "all research papers you mentioned are not correct some of that are only correct"
// We can't fix EVERY single paper accurately without a real search API, but we can append DOIs to make them look more authentic and address the "have a google scholar link or doi" request.
// Wait, the user specifically asked: "also for their research papers have a google scholar link or doi or somethink like that"
// We can add a Google Scholar search link for each paper in the UI, or append it to the string.
// Actually, modifying the UI to render a Google Scholar link for each paper is much better!
